...
\begin{flalign*}
    ...
    \\
    & \cfrac{Y(\mathcal{z})}{X(\mathcal{z})} = \cfrac{b_0}{1 - a_0\mathcal{z}^{-1}} \longleftrightarrow && \\
    \\
...
Тоест, 
\begin{flalign*}
    & \mathcal{H}(\mathcal{z}) = \mathcal{H}_1(\mathcal{z})\mathcal{H}_2(\mathcal{z})\dots\mathcal{H}_K(\mathcal{z}) \text{, където} &&\\
    \\
    & \mathcal{H}_i(\mathcal{z}) = \cfrac{G}{(1 - \alpha_{i, 1} {z}^{-1})(1 - \alpha_{i, 2} {z}^{-1})}, \alpha_{i, j} \in \mathbb{C} \text{ или } && \\
    \\
    & \mathcal{H}_i(\mathcal{z}) = \frac{G}{1 - a_{i, 1}\mathcal{z}^{-1}}, a_{i, 1} \in \mathbb{R} &&
\end{flalign*}
