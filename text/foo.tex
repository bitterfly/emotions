...
\begin{appendices}
    ...
    \begin{tikzpicture}
        ...
        \end{tikzpicture}
        \caption{Полюс-нула графика} \label{fig:appendix:1:1}
    \end{figure}

    \autoref{fig:appendix:1:1} изобразява трансферна функция с три нули и четири полюса, 
    ...
    \begin{figure}[H]%
        \centering
            ...
            \hfill
            \subfloat[Графика на амплитудата на $\mathcal{H}$ в честотния домейн за $a=0.7, a=0.5, a=0.35$]{%
            \begin{tikzpicture}[baseline]
                \begin{axis}[
            ...
            \subfloat[Графика на амплитудата на $\mathcal{H}$ за различни стойност на $a$ и $b$]{%
            \begin{tikzpicture}[baseline]
                \begin{axis}[
                    xlabel={Ъглова честота},
                    ylabel={Амплитуда},
                    ...
                    \addplot [domain=-pi:pi, samples=500, thick, dotted]{(0.2/(1 - 2*0.86*cos(deg(x)) + (0.86)^2))^1/2};
                    \end{axis}
            \end{tikzpicture}
            }
            \hfill
            \subfloat{}
        \label{fig:appendix:1:2}
    \end{figure}
