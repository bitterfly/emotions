...
\chapter{Емоции в реч}
   ...
   Това, от което се интересуваме, е $\mathcal{V}$.
    ...
    За $N=2$, $\eqref{eq:2:2:21}$ има вида:

    \begin{flalign*}
    & \mathcal{V}(\mathcal{z}) = \frac{0.5(1 + r_G)(1 + r_1)(1 + r_2)\mathcal{z}^{-1}}{1 + (r_1r_2 + r_1r_G)\mathcal{z}^{-1} + r_2r_G\mathcal{z}^{-2}} &&
    \end{flalign*}

    Може да се покаже, че за всяка стойност на $N$, уравнението $\eqref{eq:2:2:21}$ ще има решения от вида:
