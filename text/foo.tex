        ...
        \subfloat{%
            \begin{tikzpicture}[baseline]
                \begin{axis}[
                    ...
                    xmajorgrids=true,
                    grid style=dashed,]
                    \addplot [domain=0:pi, samples=500,]{2*( (1 - (1.6)*cos(deg(x)) - (-3.2)*cos(deg(2*x)))^2 + ((1.6)*sin(deg(x)) + (-3.2)*sin(deg(2*x)) )^2  )^(-1/2)};
                    \addplot [domain=0:pi, samples=500,dotted, thick]{( (1 - (2.23077)*cos(deg(x)) - (-1.23077)*cos(deg(2*x)))^2 + ((1.23077)*sin(deg(x)) + (-1.23077)*sin(deg(2*x)) )^2  )^(-1/2)};
                    \addplot [domain=0:pi, samples=500,dotted, thick]{( (1 - (1.41176)*cos(deg(x)) - (-1.88235)*cos(deg(2*x)))^2 + ((1.41176)*sin(deg(x)) + (-1.88235)*sin(deg(2*x)) )^2  )^(-1/2)};
                    \end{axis}
            \end{tikzpicture}
        }
        \caption{Действие на IIR филтър от първи ред за различни стойности на $a$ и $b$}
